...
//Sctx.js
var Sctx=(function(){var d="sctx",e="pptv.com",a="rcc_id",h={};var b={set:function(j,k){document.cookie=j+"="+escape(k)+"; ; path=/; domain=pptv.com;"},get:function(k){var j=document.cookie.match(new RegExp("(^| )"+k+"=([^;]*)(;|$)"));if(j!==null){return unescape(j[2])}return null}};function i(l,k){for(var j in k){l[j]=k[j]}return l}function c(j){var k=new RegExp("(^|\\?|&)"+j+"=([^&]*)(\\s|&|$)","i");if(k.test(location.href)){return unescape(RegExp.$2.replace(/\+/g," "))}}function g(n){if(!n||n==""){return}var m={},l=n.split("&"),j=0,k;while(l[j]){k=l[j].split("=");m[k[0]]=k[1];j++}return m}function f(k){var l=[];for(var j in k){l.push(j+"="+k[j])}return l.join("&")}return{getFormStr:function(){return this.getO()},getO:function(){var j=c(a)||function(){var k=document.referrer;if(!!k){var l=k.toLowerCase().match(/\:\/\/([0-9a-z\-\_\.{}]+).*/i)[1];if(l.indexOf(e)==-1){return l}}}()||g(decodeURIComponent(this.get("sctx"))).o||"";return j},set:function(k,l){var j="";j+=k+"="+l;i(h,g(j));b.set(d,f(h))},get:function(j){return b.get(j)},init:function(){if(this.getFormStr()){h={o:this.getFormStr()};b.set(d,f(h))}}}})();Sctx.init();
